...
const brandIconColors: Record<SkillMarqueeIconKey, string> = {
  typescript: "#3178C6",
  javascript: "#F7DF1E",
  cplusplus: "#00599C",
  react: "#61DAFB",
...
function MarqueeSkillGlyph({ icon }: { icon: SkillMarqueeIconKey }) {
  if (icon === "javascript") {
    return (
      <svg
        viewBox="0 0 24 24"
  ...
  if (icon === "assembly68k") {
    return (
      ...
      >
        ...
        <path d="M8.25 10.1h2.4l-2.4 3.8h2.4M13 10.1v3.8M15.7 10.1l-2.7 1.9 2.7 1.9" />
      </svg>
    );
  }

  return <SkillGlyph icon={icon as SkillIconKey} />;
}
    ...
    <ul className="skills-marquee-track" aria-hidden={hidden || undefined}>
      {skills.map((skill) => (
        <li key={skill.name} className="skills-marquee-item">
          ...
          >
            <MarqueeSkillGlyph icon={skill.icon} />
          </span>
